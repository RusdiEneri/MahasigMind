...
import { Journal, PaginatedLinks, PageProps, User } from '@/types';
...
export default function Index({ auth, journals }: Props) {
    ...
    const openEdit = (journal: Journal) => { setEditing(journal); setShowModal(true); };
